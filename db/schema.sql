...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS user_id INT REFERENCES users(user_id);


-- Order Items
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS quantity INT NOT NULL;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS price NUMERIC(10,2) NOT NULL;
